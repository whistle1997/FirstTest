		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal"  method="post" action="${pageContext.request.contextPath}/user/log">						
					...
					<%-- 	<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" name="autoLogin" value="autoLogin" onclick="addrem()"> 自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>																 
									    <input type="checkbox" id="rem" name="rem" value="rem"> 记住用户名						
									</label>
								</div>
							</div>
						</div>

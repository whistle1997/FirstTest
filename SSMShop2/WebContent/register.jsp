	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath}/user/reg" method="post" style="margin-top: 5px;">					
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="date" onClick="laydate()" name="birthday">
						</div>
					</div>

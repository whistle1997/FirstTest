...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/orders/addOrders" method="post"
				style="margin-top: 5px; margin-left: 150px;">				
				
				<!-- 传递订单的总金额 -->
				<input type="hidden" name="total" id="tt">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd" name="telephone" placeholder="请输入联系方式"  value="">
					</div>
				</div>
